...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - استعادة كلمة المرور</title>
        ...
        <div class="w-full max-w-[560px] bg-md-surface-container-lowest dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl premium-shadow border border-md-outline-variant/20 dark:border-white/5 relative z-10 overflow-hidden mx-4">
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold text-md-primary dark:text-slate-100 font-headline leading-tight">استعادة كلمة المرور</h1>
                    <p class="text-md-on-surface-variant dark:text-slate-400 text-sm mt-3 font-body">أدخل بريدك الإلكتروني لتلقي رابط إعادة التعيين</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                    ...
                    <button class="w-full py-4 bg-md-primary hover:bg-md-primary-container text-md-on-primary font-bold rounded-xl shadow-lg shadow-md-primary/30 border border-md-primary-container/20 transform active:scale-[0.99] transition-all duration-300 flex items-center justify-center gap-3 group" type="submit">
                        <span class="text-base">إرسال رابط إعادة التعيين</span>
                        <span class="icon-[material-symbols--mail-outline] text-[20px] group-hover:translate-x-[-4px] transition-transform"></span>
                    </button>

                    <!-- Back to Login -->
                    <div class="text-center pt-2">
                        <a href="{{ route('login') }}" class="text-sm font-bold text-md-primary dark:text-md-tertiary-fixed-dim hover:underline decoration-2 underline-offset-8">
