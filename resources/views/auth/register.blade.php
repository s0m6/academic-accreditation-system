        ...
        <div class="w-full max-w-[560px] bg-md-surface-container-lowest dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl premium-shadow border border-md-outline-variant/20 dark:border-white/5 relative z-10 overflow-hidden mx-4">
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold text-md-primary dark:text-slate-100 font-headline leading-tight">إنشاء حساب جديد</h1>
                    <p class="text-md-on-surface-variant dark:text-slate-400 text-sm mt-3 font-body">انضم إلى بوابة الاعتماد الأكاديمي</p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="space-y-2">
                        <label class="block text-sm font-bold text-md-primary dark:text-slate-300 mr-1" for="password_confirmation">تأكيد كلمة المرور</label>
                        <div class="relative group" x-data="{ show: false }">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none text-md-outline group-focus-within:text-md-primary dark:group-focus-within:text-md-tertiary-fixed-dim transition-colors">
                    ...
                    <button class="w-full py-4 bg-md-primary hover:bg-md-primary-container text-md-on-primary font-bold rounded-xl shadow-lg shadow-md-primary/30 border border-md-primary-container/20 transform active:scale-[0.99] transition-all duration-300 flex items-center justify-center gap-3 group" type="submit">
                        ...
                        <span class="icon-[material-symbols--person-add-outline] text-[20px] group-hover:translate-x-[-4px] transition-transform"></span>
                    </button>

                    <!-- Login Link -->
                    <div class="text-center pt-2">
                        <p class="text-sm text-md-on-surface-variant dark:text-slate-400">
                            لديك حساب بالفعل؟ 
                            <a href="{{ route('login') }}" class="text-md-primary dark:text-md-tertiary-fixed-dim font-bold hover:underline decoration-2 underline-offset-8 mr-2">
                                تسجيل الدخول
                            </a>
                        </p>
                    </div>
