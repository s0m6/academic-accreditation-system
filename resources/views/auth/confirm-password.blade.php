...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - تأكيد كلمة المرور</title>
        ...
        <div class="w-full max-w-[560px] bg-md-surface-container-lowest dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl premium-shadow border border-md-outline-variant/20 dark:border-white/5 relative z-10 overflow-hidden mx-4">
            ...
            <div class="p-8 md:p-12">
                ...
                <div class="text-center mb-8">
                    ...
                    <h1 class="text-2xl font-bold text-md-primary dark:text-slate-100 font-headline leading-tight">تأكيد كلمة المرور</h1>
                    <p class="text-md-on-surface-variant dark:text-slate-400 text-sm mt-3 font-body">يرجى تأكيد كلمة المرور للمتابعة</p>
                </div>

                <div class="mb-6 text-sm text-center leading-relaxed text-md-on-surface-variant dark:text-slate-400 bg-md-surface-container-low/50 dark:bg-slate-800/30 p-4 rounded-xl border border-md-outline-variant/10">
                ...
                <form method="POST" action="{{ route('password.confirm') }}" class="space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group" x-data="{ show: false }">
                            ...
                            <input :type="show ? 'text' : 'password'" id="password" name="password" required autocomplete="current-password" autofocus
                    ...
                    <button class="w-full py-4 bg-md-primary hover:bg-md-primary-container text-md-on-primary font-bold rounded-xl shadow-lg shadow-md-primary/30 border border-md-primary-container/20 transform active:scale-[0.99] transition-all duration-300 flex items-center justify-center gap-3 group" type="submit">
                        <span class="text-base">تأكيد المتابعة</span>
                        <span class="icon-[material-symbols--lock-open-outline] text-[20px] group-hover:translate-x-[-4px] transition-transform"></span>
                    </button>
                </form>
            </div>
        </div>
