...
@php
    $breadcrumbs = [
        ...
        'طلبات الاعتماد' => '#',
        'تقرير الدراسة الذاتية' => route('council_secretariat.requests.stage_three')
    ];
@endphp

@section('title', 'طلبات الاعتماد - تقرير الدراسة الذاتية')
@section('title2', 'إدارة طلبات المرحلة الثالثة')
@section('description', 'عرض ومراجعة تقارير الدراسة الذاتية المقدمة من البرامج')
    ...
    <div class="shadow-md rounded-2xl overflow-hidden border border-(--border-primary) bg-(--surface-card)">
        ...
        <div class="border-b border-(--border-primary) bg-(--content-container) px-6 py-5 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="font-bold text-(--text-primary) text-lg">قائمة تقارير الدراسة الذاتية</h3>
                    <p class="text-xs md:text-sm text-(--text-secondary) mt-0.5">مراجعة التقارير النهائية للدراسة الذاتية في المرحلة الثالثة للاعتماد</p>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-(--text-secondary) border-t border-(--border-primary)">
                                <div class="flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <span class="text-base md:text-lg font-bold">لا توجد طلبات في مرحلة تقرير الدراسة الذاتية حالياً</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
