...
@php
    $breadcrumbs = [
        ...
        'طلبات الاعتماد' => '#',
        'الطلب الأولي' => route('council_secretariat.requests.stage_one')
    ];
@endphp

@section('title', 'طلبات الاعتماد - الطلب الأولي')
@section('title2', 'إدارة طلبات المرحلة الأولى')
@section('description', 'عرض ومراجعة طلبات الاعتماد المقدمة في مرحلة الطلب الأولي')
    ...
    <div class="shadow-md rounded-2xl overflow-hidden border border-(--border-primary) bg-(--surface-card)">
        ...
        <div class="border-b border-(--border-primary) bg-(--bg-main) px-6 py-5 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="font-bold text-(--text-primary) text-lg">قائمة الطلبات الأولية</h3>
                    <p class="text-xs md:text-sm text-(--text-secondary) mt-0.5">مراجعة طلبات الاعتماد المقدمة في المرحلة الأولى للتحقق من الأهلية</p>
                </div>
            </div>
        </div>
