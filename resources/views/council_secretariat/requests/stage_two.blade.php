...
@php
    $breadcrumbs = [
        ...
        'طلبات الاعتماد' => '#',
        'البيانات الأساسية' => route('council_secretariat.requests.stage_two')
    ];
@endphp

@section('title', 'طلبات الاعتماد - البيانات الأساسية')
@section('title2', 'إدارة طلبات المرحلة الثانية')
@section('description', 'عرض ومراجعة طلبات الاعتماد في مرحلة البيانات الأساسية')
    ...
    <div class="shadow-md rounded-2xl overflow-hidden border border-(--border-primary) bg-(--surface-card)">
        ...
        <div class="border-b border-(--border-primary) bg-(--bg-main) px-6 py-5 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h3 class="font-bold text-(--text-primary) text-lg">قائمة طلبات البيانات الأساسية</h3>
                    <p class="text-xs md:text-sm text-(--text-secondary) mt-0.5">مراجعة البيانات الأساسية المرفوعة من قبل البرامج في المرحلة الثانية</p>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-(--text-secondary) border-t border-(--border-primary)">
                                <div class="flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <span class="text-base md:text-lg font-bold">لا توجد طلبات في مرحلة البيانات الأساسية حالياً</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
