...
@php
    $breadcrumbs = [
        ...
        'طلبات الاعتماد' => '#',
        'قرار الاعتماد' => route('council_secretariat.requests.stage_nine')
    ];
@endphp

@section('title', 'طلبات الاعتماد - قرار الاعتماد')
@section('title2', 'إدارة طلبات المرحلة التاسعة')
@section('description', 'عرض ومراجعة طلبات قرار الاعتماد الأكاديمي النهائية')
        ...
        <div class="border-b border-(--border-primary) bg-(--content-container) px-6 py-5 flex items-center justify-between">
            <div class="flex items-center gap-4">
                <div class="w-12 h-12 shrink-0 rounded-full bg-emerald-50 dark:bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 flex justify-center items-center shadow-inner border border-emerald-100 dark:border-emerald-500/20">
                    <span class="text-2xl font-black">9</span>
                </div>
                <div>
                    <h3 class="font-bold text-(--text-primary) text-lg">قائمة طلبات قرار الاعتماد</h3>
                    <p class="text-xs md:text-sm text-(--text-secondary) mt-0.5">مراجعة الطلبات لإصدار قرار الاعتماد الأكاديمي النهائي</p>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            <td colspan="4" class="px-6 py-12 text-center text-(--text-secondary) border-t border-(--border-primary)">
                                <div class="flex flex-col items-center justify-center space-y-4">
                                    ...
                                    <span class="text-base md:text-lg font-bold">لا توجد طلبات في مرحلة قرار الاعتماد حالياً</span>
                                </div>
                            </td>
                        </tr>
                    @endforelse
