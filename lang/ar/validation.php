...
return [
    ...
    */
    ...
    'ascii' => 'حقل :attribute يجب أن يحتوي على أحرف وأرقام وحروف رمزية ذات بايت واحد فقط.',
    ...
    'between' => [
        ...
        'string' => 'حقل :attribute يجب أن يكون عدد حروفه بين :min و :max.',
    ],
    ...
    'extensions' => 'حقل :attribute يجب أن يكون له إحدى الإضافات التالية: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'حقل :attribute المقدم ظهر في تسريب بيانات. الرجاء اختيار :attribute مختلف.',
    ],
    ...
    'unique' => 'حقل :attribute تم أخذه مسبقًا.',
